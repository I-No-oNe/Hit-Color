...
public class HitColor implements ClientModInitializer, Global {
    ...
    public static final KeyBinding BIND = KeyBindingHelper.registerKeyBinding(new KeyBinding("hit-color.i_no_am.menu", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_H, "hit-color.i_no_am.category"));
